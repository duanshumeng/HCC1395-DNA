...
def run():
    ...
    return infile, snv_out, indel_out,tumor_name,normal_name


def convert(infile, snv_out, indel_out,tumor_name,normal_name):
...
if __name__ == '__main__':
    infile, snv_out, indel_out,tumor_name,normal_name = run()
    convert(infile, snv_out, indel_out,tumor_name,normal_name)